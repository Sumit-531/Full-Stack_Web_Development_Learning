...
async function startServer() {
    try{
        ...
        app.get('/', (req: Request, res: Response) => {
         ...
         // curl -X POST -H "Content-Type: application/json" -d '{"message": "Build a team to make an android app, and tell me the talent gaps."}' 
        ...
        // curl -X POST -H "Content-Type: application/json" -d '{"message": "What team members did you recommend?"}' 
